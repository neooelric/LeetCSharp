...
namespace Tests._0046
{
    public class TestCase
    {
        ...
        {
            return string.Format("Nums:{0}, Output:{1}",
            Helper.FormatIntArray(Nums),
            Helper.FormatInt2DArray(Output));
        }
    ...
    public class Test
    {
        ...
        {
            Solutions._0046.Solution solution = new Solutions._0046.Solution();

            List<TestCase> cases = TestCase.ParseTestCaseFromTextFile(@"./0046.txt");
